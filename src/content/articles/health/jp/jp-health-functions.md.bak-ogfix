---
title: "日本卫生/医保主管部门核心职能详解（2026-2026）"
description: 系统梳理日本厚生劳动省在医疗卫生、医保、公共卫生等领域的法定职能、立法依据、执行机制、部门间协调及2024-2026年政策调整。基于2026年公开数据与法律文本。
category: health
country: jp
authority: jp-health
...
# 日本卫生/医保主管部门核心职能详解（2026-2026）

日本卫生与医保事务的主管部门为**厚生劳动省**（Ministry of Health, Labour and Welfare, MHLW）。依据《厚生劳动省设置法》（平成11年法律第97号）第3条，该省负责“国民健康、社会保障、劳动条件及福利的增进与维持”。截至2026年5月，厚生劳动省下辖11个局、6个审议会及若干独立行政法人（如国立医院机构、国立健康营养研究所等），总职员数约3.2万人（含地方分支机构）。2025年度预算总额约为32.8万亿日元，其中社会保障关系费（含医疗、年金、介护）占约88%。
...
厚生劳动省官方网站（[www.mhlw.go.jp](https://www.mhlw.go.jp)）提供日语、英语、中文（简体）三种语言版本。截至2026年5月，中文版主要提供：制度概要（如“日本医疗保险制度”）、统计年报摘要（如“国民医疗费概况”）、生活指南（如“外国人的医疗手续”）。部分重要文件（如《健康保险法》全文）仅提供日语版本。中文服务由厚生劳动省“国际课”负责维护，更新频率约为每月1次。此外，各都道府县的“外国人综合咨询窗口”可提供中文医疗制度咨询（2025年度共受理约1.2万件中文相关咨询）。
...
<div class="cc-aff-stack" data-affiliate-plain="true" data-pagefind-ignore>
  <a class="cc-aff-card cc-aff-card--oshc" href="https://go.compares.cheap/oshc-au?p=authority-org-cn/jp-health-functions" target="_blank"
