...
可通过香港卫生署药物办公室网站(www.drugoffice.gov.hk)查询药物注册状态。如需确认内地是否已批准使用，可参考国家药品监督管理局(NMPA)数据库。2025年“港澳药械通”政策允许内地医疗机构申请使用香港注册但内地未上市的药物，但需个案审批。建议通过香港注册医生开具处方后，向内地海关申报个人自用药物(合理数量)。
